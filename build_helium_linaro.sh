...
export CROSS_COMPILE=/home/xfoex/kernel5/aarch64-linux-android-4.9-linaro-4.9-2015.04/bin/aarch64-linux-android-
export ARCH="arm64"
export USE_CCACHE=1

echo -e "$green***********************************************"
echo  "           Compiling weed.kernel  HELIUM                 "
echo -e "***********************************************"
